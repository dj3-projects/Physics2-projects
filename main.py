...
lb_bh.grid(row=2, column=0, pady=20)
e_bh.grid(row=2, column=1, pady=20)
lb_bhu.grid(row=2, column=2, pady=20)
...
lb_br.grid(row=3, column=0, pady=20)
e_br.grid(row=3, column=1, pady=20)
lb_bru.grid(row=3, column=2, pady=20)
